...
We find over the course of many competitions some players teaming up 
with different set of players.  These series of relationships 
...
a Gold or Silver medal than single-player teams.  We hypothesize team collaboration is one factor for this 
observation.
...
There is a wide difference in the number of multi-player vs single-player teams.  Because of this difference, 
this analysis will focus on the percentage of teams achieving Gold, Silver or Bronze medals between 
multi-player vs single-player teams.

Medal distribution of the multi-player and single-player teams is shown in the chart below.
...
competed as a single player.  This may be the result of the collaboration of team members.
