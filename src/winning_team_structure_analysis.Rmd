...
we examine the relationships of Kaggle players on winning teams, teams placing in the top 3 places, using the **igraph** package.

Team structures are depicted using a graph model.  In this model, Kaggle
players are reprsented as vertices of a graph.  An edge exists between two vertices if
...
```{r,echo=FALSE,Efig.height=8,fig.width=7}
