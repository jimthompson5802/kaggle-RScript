...
we examine the relationships of Kaggle players on winning teams--teams placing in the top 3 places--using the **igraph** package.  The list of Kaggle competitions covered by
...
From this graph depiction we can calculate several measaures.  First the number of 
vertices in the graph, `r length(V(g))`, indcate the number Kaggle
...
We now identify the top 10 Kagglers on the graph. From this we see that 7 out of the
...
For the ten Kagglers, we now show who these players interacted with on one or more
teams.
